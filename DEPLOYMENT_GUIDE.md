# DEPLOYMENT GUIDE — GENROSE Room Scene Analyzer v0.7.2
...
8. Unzip the downloaded `Slab_Room_Scene_Manager_v0.7.2.zip`.
9. Open the folder `Slab_Room_Scene_Manager_v0.7.2`.
...
v0.7.2 prevents this failure mode. If Google Cloud returns a 403 because Vision is
...
## Review link note
v0.7.2 automatically builds review links from the live Streamlit URL. `APP_BASE_URL`
is retained only as a fallback. After deploying v0.7.2, generate a NEW review link;
