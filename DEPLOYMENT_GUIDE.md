# DEPLOYMENT GUIDE — GENROSE Room Scene Analyzer v0.7.0
...
8. Unzip the downloaded `Slab_Room_Scene_Manager_v0.7.0.zip`.
9. Open the folder `Slab_Room_Scene_Manager_v0.7.0`.
...
v0.7.0 prevents this failure mode. If Google Cloud returns a 403 because Vision is
